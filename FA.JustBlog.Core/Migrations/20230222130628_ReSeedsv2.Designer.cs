...
namespace FA.JustBlog.Core.Migrations
{
    ...
    [Migration("20230222130628_ReSeedsv2")]
    partial class ReSeedsv2
    {
            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 1,
                            CategoryId = 1,
                            Modified = new DateTime(2023, 2, 22, 20, 6, 28, 112, DateTimeKind.Local).AddTicks(9492),
                            PostContent = "Ha noi: 20C",
                            PostedOn = new DateTime(2023, 2, 22, 20, 6, 28, 112, DateTimeKind.Local).AddTicks(9482),
                            Published = "1",
                            RateCount = 0,
                        ...
                        new
                        {
                            PostId = 2,
                            CategoryId = 2,
                            Modified = new DateTime(2023, 2, 22, 20, 6, 28, 112, DateTimeKind.Local).AddTicks(9498),
                            PostContent = "1000 devoloper",
                            PostedOn = new DateTime(2023, 2, 22, 20, 6, 28, 112, DateTimeKind.Local).AddTicks(9497),
                            Published = "0",
                            RateCount = 0,
                        ...
                        new
                        {
                            PostId = 3,
                            CategoryId = 3,
                            Modified = new DateTime(2023, 2, 22, 20, 6, 28, 112, DateTimeKind.Local).AddTicks(9500),
                            PostContent = "To chuc lai bo may nha nuoc",
                            PostedOn = new DateTime(2023, 2, 22, 20, 6, 28, 112, DateTimeKind.Local).AddTicks(9500),
                            Published = "1",
                            RateCount = 0,
