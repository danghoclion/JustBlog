...
namespace FA.JustBlog.Core.Migrations
{
    ...
    [Migration("20230301100107_updatee")]
            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 1,
                            CategoryId = 1,
                            Modified = new DateTime(2023, 3, 1, 17, 1, 6, 721, DateTimeKind.Local).AddTicks(1663),
                            PostContent = "Ha noi: 20C",
                            PostedOn = new DateTime(2023, 3, 1, 17, 1, 6, 721, DateTimeKind.Local).AddTicks(1653),
                            Published = "1",
                            RateCount = 0,
                        ...
                        new
                        {
                            PostId = 2,
                            CategoryId = 2,
                            Modified = new DateTime(2023, 3, 1, 17, 1, 6, 721, DateTimeKind.Local).AddTicks(1670),
                            PostContent = "1000 devoloper",
                            PostedOn = new DateTime(2023, 3, 1, 17, 1, 6, 721, DateTimeKind.Local).AddTicks(1670),
                            Published = "0",
                            RateCount = 0,
                        ...
                        new
                        {
                            PostId = 3,
                            CategoryId = 3,
                            Modified = new DateTime(2023, 3, 1, 17, 1, 6, 721, DateTimeKind.Local).AddTicks(1672),
                            PostContent = "To chuc lai bo may nha nuoc",
                            PostedOn = new DateTime(2023, 3, 1, 17, 1, 6, 721, DateTimeKind.Local).AddTicks(1671),
                            Published = "1",
                            RateCount = 0,
