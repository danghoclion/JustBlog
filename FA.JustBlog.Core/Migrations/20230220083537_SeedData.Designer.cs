...
namespace FA.JustBlog.Core.Migrations
{
    ...
    [Migration("20230220083537_SeedData")]
            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 1,
                            CategoryId = 1,
                            Modified = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5472),
                            PostContent = "Ha noi: 20C",
                            PostedOn = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5472),
                            Published = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5461),
                        ...
                        new
                        {
                            PostId = 2,
                            CategoryId = 2,
                            Modified = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5475),
                            PostContent = "1000 devoloper",
                            PostedOn = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5475),
                            Published = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5474),
                        ...
                        new
                        {
                            PostId = 3,
                            CategoryId = 3,
                            Modified = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5477),
                            PostContent = "To chuc lai bo may nha nuoc",
                            PostedOn = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5476),
                            Published = new DateTime(2023, 2, 20, 15, 35, 36, 851, DateTimeKind.Local).AddTicks(5476),
